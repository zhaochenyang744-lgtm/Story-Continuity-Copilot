...
class DeepSeekProviderRegressionTests(unittest.TestCase):
    ...
    def test_continuity_prompt_contract_covers_unknown_facts_categories_and_complete_direct_evidence_without_case_hardcoding(self):
        ...
        self.assertIn('reviewable tension remains', joined)
        self.assertIn('why judgment stops', joined)
        self.assertIn('evidence_chain must contain each cited span exactly once', joined)
